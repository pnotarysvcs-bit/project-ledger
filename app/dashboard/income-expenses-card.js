  ...
  return (
    <article className="widget glance-card" aria-label="Monthly income versus expenses">
      ...
      <div className="glance-grid">
        <div className="glance-item blue"><small>Income</small><strong>{money.format(net.income)}</strong><span>Paychecks {money.format(net.paychecks)} · notary {money.format(net.notarySupport)}</span></div>
