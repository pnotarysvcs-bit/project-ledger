...
export default async function BillsPage({ searchParams }) {
  ...
  const incomeCardSummary = loadError ? null : summary;
  ...
  return <>
    ...
    <IncomeExpensesCard summary={incomeCardSummary} selectedMonth={selectedMonth} />
